 ...
 * \value [since 6.27] ERR_COLLECTIONCREATE
 ...
 * \value ERR_MALFORMED_RESPONSE \since 6.31
 */
enum ErrorNumber {
    NO_ERR = 0,
    ...
    ERR_COLLECTIONCREATE = ERR_PROBLEM_WITH_REQUEST + 40,
    ...
    ERR_DAVPUSH_REGISTER = ERR_PROBLEM_WITH_REQUEST + 150,
    ERR_MALFORMED_RESPONSE = ERR_PROBLEM_WITH_REQUEST + 200,
};
